...
const CORREDORES = [
  ...
  // Escenario B: payin vía Fintoc SpA + payout vía Vita withdrawal
  {
    ...
    minAmountOrigin:        30000,      // mínimo 10.000 CLP (~10 USD)
  ...
  ...[
    ...
    payoutFeeFixed:         0,
    profitRetentionPercent: 0.8,
    minAmountOrigin:        dest === 'GB' ? 2200 : 300,
    maxAmountOrigin:        null,
    legalEntity:            'SRL',
    routingScenario:        'C',
    isActive:               true,
  ...
  // ── SRL Bolivia → Europa (vitaWallet vita_sent) ────────────────────────────
  {
    corridorId:             'bo-es',
    originCountry:          'BO',
    ...
    routingScenario:        'C',
    isActive:               true,
    adminNotes:             'Corredor BO→ES. Payin manual SRL, payout Vita vita_sent. EUR destino.',
  },
  {
    corridorId:             'bo-pl',
    originCountry:          'BO',
    ...
    routingScenario:        'C',
    isActive:               true,
    adminNotes:             'Corredor BO→PL. Payin manual SRL, payout Vita vita_sent. PLN destino.',
  },

  // ── SRL Bolivia → Canadá y Hong Kong (vitaWallet withdrawal) ──────────────
  {
    corridorId:             'bo-ca',
    originCountry:          'BO',
    ...
    routingScenario:        'C',
    isActive:               true,
    adminNotes:             'Corredor BO→CA. Payin manual SRL, payout Vita withdrawal causd. CAD destino.',
  },
  {
    corridorId:             'bo-hk',
    originCountry:          'BO',
    ...
    routingScenario:        'C',
    isActive:               true,
    adminNotes:             'Corredor BO→HK. Payin manual SRL, payout Vita withdrawal hkusd. HKD destino.',
  },

  // ── SRL Bolivia → Asia/África (OwlPay Harbor — Vita no cubre) ─────────────
  {
    corridorId:             'bo-jp',
    originCountry:          'BO',
    ...
    routingScenario:        'C',
    isActive:               true,
    adminNotes:             'Corredor BO→JP. Payin manual SRL, payout OwlPay Harbor. JPY destino.',
  },
  {
    corridorId:             'bo-sg',
    originCountry:          'BO',
    ...
    routingScenario:        'C',
    isActive:               true,
    adminNotes:             'Corredor BO→SG. Payin manual SRL, payout OwlPay Harbor. SGD destino.',
  },
  {
    corridorId:             'bo-za',
    originCountry:          'BO',
    ...
    routingScenario:        'C',
    isActive:               true,
    adminNotes:             'Corredor BO→ZA. Payin manual SRL, payout OwlPay Harbor. ZAR destino.',
  },
  {
    corridorId:             'bo-ng',
    originCountry:          'BO',
    ...
    routingScenario:        'C',
    isActive:               true,
    adminNotes:             'Corredor BO→NG. Payin manual SRL, payout OwlPay Harbor. NGN destino. Mayor spread por riesgo Nigeria.',
  },
